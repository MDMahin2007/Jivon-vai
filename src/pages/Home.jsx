...
import { FaChevronLeft, FaChevronRight, FaPlus, FaCheck, FaPhone, FaEnvelope, FaMapMarkerAlt } from 'react-icons/fa';
...
export default function Home() {
  ...
  const heroSlides = [
    {
      ...
      description: 'At Arcforma Studio, we combine physical structure with visual intelligence to create breathtaking architectural solutions.'
    },
    {
      image: '/img/project-1/Scene 25_1.png',
      title: 'Luxury Residential Duplex',
      subtitle: 'RESIDENTIAL',
      description: 'Clean modern layouts, smart lighting systems, and high-end materials selected for functional, high-density comfort.'
    },
    {
      image: '/img/project-9/Scene 5.png',
      title: 'Corporate Headquarters',
      subtitle: 'COMMERCIAL',
      description: 'Bespoke architectural execution and interior zoning representing sleek professional productivity.'
    },
    {
      image: '/img/project-3/Scene 7_1.png',
      title: 'Sustainable Villa Blueprint',
      subtitle: 'SITE PLANNING',
      description: 'Detail-oriented space utilization and exterior concepts tailored for architectural sustainability.'
    }
  ];
  ...
  const handleFormSubmit = (e) => {
    ...
    if (!formValues.name.trim()) { errors.name = true; isValid = false; }
    if (!formValues.phone.trim()) { errors.phone = true; isValid = false; }
    if (!formValues.email.trim()) { errors.email = true; isValid = false; }
    if (!formValues.interest.trim()) { errors.interest = true; isValid = false; }
    if (!formValues.message.trim()) { errors.message = true; isValid = false; }
      ...
      <section className="py-24 bg-dark relative bg-grid-pattern">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            <p className="text-primary font-heading text-xs tracking-[0.3em] font-bold mb-3">ABOUT US</p>
            ...
            <p className="text-gray-400 font-sans leading-relaxed mb-6 text-sm sm:text-base">
              Welcome to <strong>Arcforma Studio</strong>. We are a dedicated and innovative architectural visualization company focused on delivering high-quality visual designs to our clients. Our goal is to provide reliable, efficient, and modern structural design concepts that inspire and scale.
            </p>
            <p className="text-gray-400 font-sans leading-relaxed mb-8 text-sm sm:text-base">
              At Arcforma Studio, we believe in professionalism, creativity, and customer satisfaction. Our expert design team works tirelessly to map blueprints into cinematic 3D environments.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-panel p-10 flex flex-col items-start text-left hover-glow">
              <h3 className="text-xl font-bold font-heading mb-4 text-white">Visual Design</h3>
              <p className="text-sm text-gray-400 leading-relaxed mb-6">
                From structural concepts to hyper-realistic walkthrough animations, we deliver unmatched drafting excellence.
              </p>
              <ul className="text-xs text-gray-500 flex flex-col gap-2 font-heading font-medium">
                <li className="flex items-center gap-2">
                  <FaCheck className="text-primary" /> Architectural Building Design
                </li>
                <li className="flex items-center gap-2">
                  <FaCheck className="text-primary" /> 3D Exterior & Interior Renders
                </li>
                <li className="flex items-center gap-2">
                  <FaCheck className="text-primary" /> Modern Space Planning
                </li>
                <li className="flex items-center gap-2">
                  <FaCheck className="text-primary" /> Walkthrough Video Production
                </li>
              </ul>
            </div>

            {servicesData.slice(0, 2).map((service) => (
              <div key={service.id} className="glass-panel p-10 flex flex-col items-start text-left hover-glow">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            {featuredProjects.slice(0, 5).map((project, idx) => {
              // Custom grid classes to match the dynamic layout
              const gridSpan = idx === 0 || idx === 1 ? 'md:col-span-6 h-[400px]' : 'md:col-span-4 h-[300px]';
              return (
                <div
                  key={project.id}
      ...
      <section className="py-24 bg-dark-accent border-t border-dark-border/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-left">
              <p className="text-primary font-heading text-xs tracking-[0.3em] font-bold mb-3">CONTACT US</p>
              ...
              <p className="text-gray-400 font-sans leading-relaxed mb-8 max-w-md">
                Have a design concept or a complex architectural mapping job? Get in touch with our team today and receive a detailed project outline.
              </p>
              <div className="flex flex-col gap-6 text-sm text-gray-400">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-xs tracking-wider font-heading font-bold text-white uppercase">Location</h4>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-xs tracking-wider font-heading font-bold text-white uppercase">Phone</h4>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-xs tracking-wider font-heading font-bold text-white uppercase">Email</h4>
            ...
            {/* Form */}
            <form onSubmit={handleFormSubmit} className="glass-panel p-10 flex flex-col gap-4">
              <div>
                <input
                  type="text"
                  name="name"
                  ...
                  className={`w-full bg-dark/60 text-white border ${
                    formErrors.name ? 'border-red-500' : 'border-dark-border/60 focus:border-primary'
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  className={`w-full bg-dark/60 text-white border ${
                    formErrors.phone ? 'border-red-500' : 'border-dark-border/60 focus:border-primary'
                  } px-5 py-4 text-sm focus:outline-none transition-colors duration-300`}
                />
                <input
                  type="email"
                  ...
                  placeholder="Email*"
                  className={`w-full bg-dark/60 text-white border ${
                    formErrors.email ? 'border-red-500' : 'border-dark-border/60 focus:border-primary'
                  } px-5 py-4 text-sm focus:outline-none transition-colors duration-300`}
                />
              </div>
              <div>
                <input
                  ...
                  className={`w-full bg-dark/60 text-white border ${
                    formErrors.interest ? 'border-red-500' : 'border-dark-border/60 focus:border-primary'
                  } px-5 py-4 text-sm focus:outline-none transition-colors duration-300`}
                />
              </div>
              <div>
                <textarea
                  ...
                  rows="4"
                  className={`w-full bg-dark/60 text-white border ${
                    formErrors.message ? 'border-red-500' : 'border-dark-border/60 focus:border-primary'
                  } px-5 py-4 text-sm focus:outline-none transition-colors duration-300 resize-none`}
                />
              </div>
              <button
                type="submit"
                className="bg-primary hover:bg-primary-hover text-dark font-heading text-xs tracking-widest font-bold py-4 transition-all duration-300 shadow-md"
              >
                SEND EMAIL &rarr;
              </button>
            </form>
