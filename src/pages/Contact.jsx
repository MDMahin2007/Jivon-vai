    ...
    <div className="py-24 bg-dark relative bg-grid-pattern min-h-screen">
      <div className="max-w-7xl mx-auto px-6 mt-12 text-left">
        ...
        <div className="text-left mb-16">
          <p className="text-primary font-heading text-xs tracking-[0.3em] font-bold mb-3">CONTACT</p>
          ...
          <div className="flex flex-col gap-8">
            <div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed max-w-md">
                Our inbox is always open. Whether you have a question about a project, wish to collaborate on interior drafts, or simply want to speak about design ideas, we are ready to assist.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="glass-panel p-6 flex flex-col items-start gap-4">
                ...
                <div>
                  <h4 className="text-xs tracking-wider font-heading font-bold text-white uppercase mb-1">Address</h4>
                  <p className="text-[11px] text-gray-400 leading-snug">Dhaka, Bangladesh</p>
                </div>
              </div>
              ...
              <div className="glass-panel p-6 flex flex-col items-start gap-4">
                ...
                <div>
                  <h4 className="text-xs tracking-wider font-heading font-bold text-white uppercase mb-1">Phone</h4>
                  <p className="text-[11px] text-gray-400 leading-snug">+8801882111979</p>
                </div>
              </div>
              ...
              <div className="glass-panel p-6 flex flex-col items-start gap-4">
                ...
                <div>
                  <h4 className="text-xs tracking-wider font-heading font-bold text-white uppercase mb-1">Email</h4>
                  <p className="text-[11px] text-gray-400 leading-snug break-all">arcformastudio@gmail.com</p>
                </div>
              </div>
            </div>
